...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class MyGrabFree : MonoBehaviour, ITransformer
    {
        [SerializeField]
        ...
        // ConstrainAxisをトグルするプロパティ
        public bool ConstrainXAxis
        {
            get => _positionConstraints.XAxis.ConstrainAxis;
            set => _positionConstraints.XAxis.ConstrainAxis = value;
        }
        public bool ConstrainYAxis
        {
            get => _positionConstraints.YAxis.ConstrainAxis;
            set => _positionConstraints.YAxis.ConstrainAxis = value;
        }
        public bool ConstrainZAxis
        {
            get => _positionConstraints.ZAxis.ConstrainAxis;
            set => _positionConstraints.ZAxis.ConstrainAxis = value;
        }
