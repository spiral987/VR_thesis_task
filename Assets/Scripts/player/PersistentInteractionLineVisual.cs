...
namespace Oculus.Interaction.DistanceReticles
{
    ...
    /// </summary>
    public abstract class PersistentInteractionLineVisual : MonoBehaviour
    {
        /// <summary>
        ...
        protected bool _shouldDrawLine;
        ...
        protected virtual void HandleStateChanged(InteractorStateChangeArgs args)
        {
